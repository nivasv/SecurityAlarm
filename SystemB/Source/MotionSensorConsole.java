...
public class MotionSensorConsole
{
	public static void main(String args[])
	{
		...
		MotionSensor Sensor = null;			// The Security monitor system Monitor
		...
		/////////////////////////////////////////////////////////////////////////////////
 		...
 		if ( args.length != 0 )
 		{
			...
			Sensor = new MotionSensor( args[0] );
		...
		if (Sensor.IsRegistered() )
		{
			...
			while (!Done)
			{
				...
				System.out.println( "\n\n\n\n" );
				System.out.println( "Motion Sensor Console: \n" );

				// Here is the main menu

				System.out.println( "Select an Option: \n" );
				System.out.println( "0: Motion detected" );
				System.out.println( "1: No motion is detected" );
				System.out.print( "\n>>>> " );
