...
public class FireSensorConsole
{
	public static void main(String args[])
	{
		...
		FireSensor Sensor = null;		// The Security monitor system Monitor
		...
		if (Sensor.IsRegistered() )
		{
			...
			while (!Done)
			{
				...
				System.out.println( "\n\n\n\n" );
				System.out.println( "Fire Sensor Console: \n" );

				// Here is the main menu

				System.out.println( "Select an Option: \n" );
				System.out.println( "0: Fire" );
				System.out.println( "1: No Fire" );
				System.out.print( "\n>>>> " );
