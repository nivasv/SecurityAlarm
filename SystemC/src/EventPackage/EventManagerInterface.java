...
public class EventManagerInterface
{
	...
	****************************************************************************/
	...
	public EventManagerInterface(String name, String description) throws LocatingEventManagerException, RegistrationException, ParticipantAlreadyRegisteredException
	{
	...
	****************************************************************************/
	...
	public EventManagerInterface( String ServerIpAddress, String name, String description ) throws LocatingEventManagerException,
	...
	****************************************************************************/
	...
	public void AddDevice(String name, String description ) throws ParticipantNotRegisteredException
	{
		if (ParticipantId != -1)
		{
		   	this.DeviceName = name.toUpperCase();
		   	this.DeviceDescription = description.toUpperCase();
		   	
			// Here we create the event.

			Event evt;
			String eventMessage = Long.toString(ParticipantId) + ":" + DeviceName + ":" + DeviceDescription;

			evt = new Event( 21, eventMessage );
			try
			{
				SendEvent( evt );
			...
			{
				System.out.println("Error sending ADD DEVICE message:: " + eventMessage + " **** " + e);

			} // catch

	    } else {

			throw new ParticipantNotRegisteredException( "Participant not registered. Cannot Add Device." );
	...
	****************************************************************************/
	...
	public void RemoveDevice() throws ParticipantNotRegisteredException
	{
		if (ParticipantId != -1)
		{
			// Here we create the event.
			...
			Event evt;
			String eventMessage = Long.toString(ParticipantId);

			evt = new Event( 22, eventMessage );
			...
			{
				System.out.println("Error sending REMOVE DEVICE message:: " + eventMessage + " **** " + e);

			} // catch

	    } else {

			throw new ParticipantNotRegisteredException( "Participant not registered. Cannot Remove Device." );
	...
	****************************************************************************/
	...
	public void HealthResponse()
	{
		if (ParticipantId != -1)
		{
			...
			{
				System.out.println("Error sending Health response message:: " + eventMessage + " **** " + e);

			} // catch

	    } else {

	    	System.out.println("Error sending Health response message:: Device is not registered.");
