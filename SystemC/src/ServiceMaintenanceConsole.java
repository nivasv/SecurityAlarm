...
public class ServiceMaintenanceConsole
{
	public static void main(String args[])
	{
		...
		ServiceMaintenanceMonitor Monitor = null;		// The Security monitor system Monitor
		/////////////////////////////////////////////////////////////////////////////////
		...
		if (Monitor.IsRegistered() )
		{
			...
			while (!Done)
			{
				...
				System.out.println( "\n\n\n\n" );
				System.out.println( "Service Maintenance System (SMS) Command Console: \n" );
				...
				if ( Option.equals( "1" ) )
				{
					...
					System.out.println( "Devices listed in the console. \n" );
					Monitor.ListDevices();
