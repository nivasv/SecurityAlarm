		...
		/////////////////////////////////////////////////////////////////////////////////
 		...
 		if ( args.length == 0 )
 		{
			...
			try
			{
				...
				em = new EventManagerInterface("Temperature Sensor", "To check the temperature status");
			}
			...
			try
			{
				...
				em = new EventManagerInterface( EvtMgrIP,"Temperature Sensor", "To check the temperature status" );
			}
