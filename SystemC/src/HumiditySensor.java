		...
		/////////////////////////////////////////////////////////////////////////////////
 		...
 		if ( args.length == 0 )
 		{
			...
			try
			{
				...
				em = new EventManagerInterface("Humidity Sensor", "To check the humidity status");
			}
			...
			try
			{
				...
				em = new EventManagerInterface( EvtMgrIP, "Humidity Sensor", "To check the humidity status" );
			}
