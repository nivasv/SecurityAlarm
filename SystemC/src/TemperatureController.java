		...
		/////////////////////////////////////////////////////////////////////////////////
 		...
 		if ( args.length == 0 )
 		{
			...
			try
			{
				...
				em = new EventManagerInterface("Temperature Controller", "To control the temperature");
			}
			...
			try
			{
				...
				em = new EventManagerInterface( EvtMgrIP, "Temperature Controller", "To control the temperature" );
			}
