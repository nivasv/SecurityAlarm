	...
	public static void main(String args[])
	{
		...
		if (Monitor.IsRegistered() )
		{
			...
			while (!Done)
			{
				...
				System.out.println( "2: Fire Alarm" );
				System.out.print( "\n>>>> " );
				...
				if ( Option.equals( "2" ) )
				{
					if (Monitor.getCurrentSprinklerStatus() == 1){
						System.out.println( "Sprinkler turned on. Select an Option: \n" );
						System.out.println( "0: Turn off Sprinkler" );
						...
						if (Monitor.getCurrentFireStatus() == 0){
							Error = true;
							while(Error){
								System.out.println( "Fire detected. Select an Option: \n" );
								System.out.println( "1: Confirm Sprinkler" );
								System.out.println( "2: Cancel Sprikler" );
								System.out.println( "Q: Exit\n" );
								System.out.print( "\n>>>> " );
								Option = UserInput.KeyboardReadString();

								if ( Option.equals( "1" ) ){
									Monitor.setUserSprinklerStatus(0);
									Error = false;
								}
								
								if ( Option.equals( "2" ) ){
									Monitor.setUserSprinklerStatus(1);
									Error = false;
								}
							...
							System.out.println( "\nNo fire detected. No user action needed on Sprinkler.\n" );
						}
					}
