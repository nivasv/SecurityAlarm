...
public class WindowSensorConsole
{
	public static void main(String args[])
	{
		...
		WindowSensor Sensor = null;			// The Security monitor system Monitor
		...
		/////////////////////////////////////////////////////////////////////////////////
 		...
 		if ( args.length != 0 )
 		{
			...
			Sensor = new WindowSensor( args[0] );
		...
		if (Sensor.IsRegistered() )
		{
			...
			while (!Done)
			{
				...
				System.out.println( "\n\n\n\n" );
				System.out.println( "Window Sensor Console: \n" );

				// Here is the main menu

				System.out.println( "Select an Option: \n" );
				System.out.println( "0: Break/Open Window" );
				System.out.println( "1: Window is closed" );
				System.out.print( "\n>>>> " );
